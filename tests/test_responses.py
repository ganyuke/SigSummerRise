        ...
        json.dumps(
            {
                ...
                "declined": "declined",
                "opted_out": "out",
                "unopted_command_rejection": "no consent",
                "opt_out_group_notice": "group {minutes}",
                "opt_out_confirm_dm": "confirm {bot_name} {count} {messages} {minutes}",
                "opt_out_pending_cancelled": "cancelled",
